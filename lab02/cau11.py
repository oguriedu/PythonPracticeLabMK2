ngay=int(input('Nhập vào 1 ngày :'))
...
if ngay==ngayct:
    if thang==12:
        ngaytt=1
        thangtt=1
        # print('Ngày tiếp theo của ngày {} tháng {} là ngày 1 tháng 1'.format(ngay,thang))
    else :
        ngaytt=1
        thangtt=thang+1
else :
    ngaytt=ngay+1
    thangtt=thang
print('Ngày tiếp theo của ngày {} tháng {} là ngày {} tháng {}'.format(ngay,thang,ngaytt,thangtt))
